...
WebUI.setText(findTestObject('Object Repository/Input Petani Berhasil/Page_/input_Id User_id_user (1)'), 'angel')

WebUI.setText(findTestObject('Object Repository/Input Petani Berhasil/Page_/input_Nama Petani_nama_petani'), 'angel')
